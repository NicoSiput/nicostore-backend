...
@section('content')
<div class="card">
    <div class="card-header">Tambah FotoBarang</div>
    <div class="card-body card-block">
        <form action="{{ route('products-gallery.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <br />
                <label>
                    <input type="radio" value='1' name="is_default" class=" @error('is_default') is-invalid @enderror" /> Ya
                </label>

                <label>
                    <input type="radio" value='0' name="is_default" class=" @error('is_default') is-invalid @enderror" /> Tidak
                </label>
